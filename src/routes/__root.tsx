...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Tiny Tots ABC — Learn Letters, Numbers & More" },
      { name: "description", content: "A gentle, playful learning app for kids: alphabet, numbers, colors, shapes, animal sounds, tracing, matching and quiz." },
      { property: "og:title", content: "Tiny Tots ABC — Learn Letters, Numbers & More" },
      { property: "og:description", content: "A gentle, playful learning app for kids: alphabet, numbers, colors, shapes, animal sounds, tracing, matching and quiz." },
